...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 text-gray-800 overflow-hidden">
  ...
  <section className="mb-16 relative">
    ...
    <div className="absolute inset-0">
      <img 
        src="https://media.istockphoto.com/id/1471839731/photo/a-young-woman-pharmacist-arranges-medicines-on-the-shelves-of-the-pharmacy.jpg?s=612x612&w=0&k=20&c=UPc3UdlCCcJ3mcruTJzlkjgDyKusnrY2G6QXeXSbuTk=" // Replace with your image path
