...
export default function ModernSupplierDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      {/* Modern Sidebar */}
      <div className="fixed left-0 top-0 w-64 h-full bg-white shadow-xl border-r border-slate-200 z-50">
        ...
        <nav className="p-4 space-y-2">
          <button className="w-full flex items-center gap-3 px-4 py-3 text-emerald-700 bg-gradient-to-r from-emerald-50 to-emerald-100 rounded-xl font-medium">
            <BarChart2 className="w-5 h-5" />
            Dashboard
          </button>
          <button className="w-full flex items-center gap-3 px-4 py-3 text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-xl transition-all">
          ...
          <div className="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-xl p-4 text-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-emerald-100">Premium Plan</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="ml-64 p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-800">Supply Chain Dashboard</h1>
            <p className="text-slate-600 mt-1">Monitor and manage your pharmaceutical supply operations</p>
          </div>
          <div className="flex items-center gap-4">
            <button className="relative p-3 text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-xl transition-all">
            ...
            <button className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-6 py-3 rounded-xl font-medium hover:shadow-lg transition-all flex items-center gap-2">
