...
//                 <Link
//                   href="/registration?type={userTypes[selectedUserType].name}"
...
//   const toggleGetStartedOptions = () => {
//     setShowGetStartedOptions(!showGetStartedOptions);
//   };
...
//           className="fixed top-4 right-4 z-50 p-2 rounded-md bg-green-600 text-white focus:outline-none"
...
//                 key={key}
//                 onClick={() => {
//                   handleUserTypeChange(key);
//                   setMobileMenuOpen(false);
//                 }}
//                 className={`w-full py-3 px-4 rounded-lg flex items-center space-x-3 ${
//                   selectedUserType === key
...
//               <button
//                 onClick={toggleGetStartedOptions}
...
//             className="mt-8 text-gray-600 hover:text-green-600"
//           >
//             Close Menu
//           </button>
//         </div>
...
//                   {userTypes.chemist.icon}
//                 </div>
//                 <span>Register as Chemist</span>
//               </Link>
//               <Link
...
//             {/* User Type Selection - Hidden on mobile when menu is open */}
//             {(!isMobile || !mobileMenuOpen) && (
//               <>
//                 <div className="mb-5">
//                   <label className="block text-sm font-medium text-gray-700 mb-3">
...
export default function MultiUserLogin() {
  ...
  const userTypes = {
    chemist: {
      ...
      registerPath: "/registration/chemist"
    },
    supplier: {
      title: "MadiEase",
      name: "Supplier Portal",
      ...
      registerPath: "/registration/supplier"
    },
    superadmin: {
      title: "MadiEase",
      name: "Super Admin",
      ...
      registerPath: "/registration/superadmin"
    },
  };
